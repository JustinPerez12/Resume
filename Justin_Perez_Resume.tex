...
\name{Justin D.}{Perez}
\address{1133 E 200 S, Salt Lake City, UT 84102}
\mobile{(+1) 770-778-0722}

\email{justinprz12@gmail.com}
\homepage{www.justindavidperez.com}
\github{JustinPerez12}
\linkedin{justindperez}
%\skype{skypeid}
...
\position{Software Engineer 1} % Your expertise/fields

\makecvfooter{\today}{Justin D. Perez~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
