...
\item {Built a backend system leveraging Node.js, seamlessly integrated with a PostgreSQL database hosted on Azure. Levered Prisma ORM to increase speed in development, and mitigate SQL injection risk.}
